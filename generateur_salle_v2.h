...
class h_corridor {//pour créer les corridors horizontaux
public:

h_corridor(int x_min,int y_min, int y_max): x_min(x_min), y_min(y_min), y_max(y_max) {}
...
class v_corridor {//pour créer les corridors verticaux
public:

v_corridor(int x_min,int x_max, int y_min): x_min(x_min), y_min(y_min), x_max(x_max) {}
